...
function (_Component) {
  ...
  createClass(Alert, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(reactTransitionGroup_4
      ...
      }, alertTip), React__default.createElement("div", {
        className: "dialog-alert-content"
      }, alertCon), React__default.createElement("div", {
...
function (_Component) {
  ...
  createClass(AlertWarp, [{
    key: "render",
    value: function render() {
      return React__default.createElement(Alert, _extends_1({}, this.state, {
