...
var AlertBox = shared.prefixClsProperty(Alert);
...
function (_Component) {
  ...
  createClass(AlertWarp, [{
    key: "render",
    value: function render() {
      return React__default.createElement(AlertBox, _extends_1({}, this.state, {
...
var alertBox = ReactDOM.render(React__default.createElement(AlertWarp, null), div);
