...
function (_Component) {
  ...
  createClass(RenderBox, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", props, props.children);
    }
  }]);
...
function (_Component) {
  ...
  function Dialog(_props) {
    ...
    defineProperty(assertThisInitialized(_this), "getDialogElement", function () {
      ...
      if (closable) {
        closer = React__default.createElement("button", {
          onClick: _this.close,
          "aria-label": "Close",
      ...
      var dialogElement = React__default.createElement(RenderBox, {
        key: "dialog-element",
        role: "document",
        ref: function ref(el) {
      ...
      }, closer, header, React__default.createElement("div", {
  ...
  createClass(Dialog, [{
    ...
    value: function getMaskElement() {
      ...
      if (props.mask) {
        ...
        maskElement = React__default.createElement(RenderBox, _extends_1({
          key: "mask-element",
        ...
        if (maskTransition) {
          maskElement = React__default.createElement(Animate, {
            key: "mask",
            showProp: "visible",
            transitionAppear: true,
            component: "",
    ...
    value: function render() {
      ...
      return React__default.createElement("div", null, this.getMaskElement(), React__default.createElement("div", _extends_1({
...
function (_Component) {
  ...
  function DialogWrap(_props) {
    ...
    defineProperty(assertThisInitialized(_this), "getComponent", function (visible) {
      ...
      return React__default.createElement(Dialog, _extends_1({}, props, {
        visible: visible,
...
function (_Component) {
  ...
  createClass(Modal, [{
    ...
    value: function render() {
      ...
      var footerDom = footer.length ? React__default.createElement("div", {
      ...
      return React__default.createElement(DialogWrap, _extends_1({}, restProps, {
        prefixCls: prefixCls,
