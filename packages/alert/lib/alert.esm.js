...
function (_Component) {
  ...
  function Alert(props) {
    ...
    defineProperty(assertThisInitialized(_this), "callBackClose", function () {
      if (_this.props.callBackClose) {
        _this.props.callBackClose();
      }
    });
  ...
  createClass(Alert, [{
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          alertShow = _this$state.alertShow,
          alertStatus = _this$state.alertStatus,
          alertTip = _this$state.alertTip,
          alertCon = _this$state.alertCon;
      return React.createElement(reactTransitionGroup_4
      ...
      , {
        ...
        className: "dialog-alerttitle"
      }, alertTip), React.createElement("div", {
        className: "dialog-alert-content"
      }, alertCon), React.createElement("div", {
...
function (_Component) {
  ...
  createClass(AlertWarp, [{
    key: "render",
    value: function render() {
      return React.createElement(Alert, _extends_1({}, this.state, {
